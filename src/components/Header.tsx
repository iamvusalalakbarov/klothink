...
const Header = () => {
  ...
  return (
    <>
      {/* Laptop, Desktop View */}
      <header className="wrapper relative hidden items-center justify-between border-b border-light-95 bg-white py-[18px] laptop:flex">
        ...
        >
          <Image src="/images/logo.svg" alt="Klothink Logo" fill unoptimized />
        </Link>
      ...
      {/* Mobile View */}
      <header className="wrapper flex items-center justify-between border-b border-light-95 bg-white py-5 laptop:hidden">
